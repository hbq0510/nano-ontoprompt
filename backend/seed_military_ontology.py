...
def seed():
    ...
    if not admin:
        print("[ERROR] 没有 admin 用户，请先注册/登录")
        return
    user_id = admin.id
    ...
    if existing:
        print(f"[WARN] 军事防空反导本体已存在: {existing.id}")
    ...
    instances_data = [
        ...
        ("MidRangeInterceptor", "HongQi-9", {
            ...
            "max_range_km": 250, "min_range_km": 5,
            "kill_prob_single": 0.80, "ammo_count": 24,
            "reload_time_ms": 5000, "max_altitude_km": 30,
            "speed_mach": 6, "status": "standby",
        }),
        ("CIWS", "CIWS_A", {
            "latitude": 31.22, "longitude": 121.48,
            "max_range_km": 80, "kill_prob_single": 0.85,
            "ammo_count": 500, "fire_rate_rpm": 6000,
            "status": "standby",
        }),
        ("BallisticMissile", "DF-26B", {
            "latitude": 35.50, "longitude": 124.50,
            "speed_mach": 20, "rcs": 0.5,
            "warhead_type": "HE", "apogee_km": 100,
            "target_latitude": 31.23, "target_longitude": 121.47,
            "direction_deg": 215, "status": "flying",
        }),
        ("CruiseMissile", "CJ-10", {
            "latitude": 34.00, "longitude": 123.00,
            "speed_mach": 8, "rcs": 0.1,
            "flight_altitude_m": 50, "direction_deg": 210,
            "status": "flying",
        }),
        ("Decoy", "Decoy_A", {
            "latitude": 33.50, "longitude": 122.50,
            "speed_mach": 8, "rcs": 2.0,
            "is_decoy": True, "direction_deg": 215,
            "status": "flying",
        }),
...
"""),
    ...
    print(f"   Refresh: http://localhost:5173/ontologies")
